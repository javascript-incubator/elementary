...
const callTimes = (fn, ...args) => monad =>
  args.reduce((acc, x) => acc[fn](y => getProp(x)(y)), monad);

const accessRaw = uncurry(accessorString => object =>
  callTimes('chain', ...accessorString.split('.'))(Maybe(object)),
);
