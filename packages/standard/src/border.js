...
const borderStyleGroupFrame = directions.map(borderStylePropFrame).concat(directions.map(borderWidthPropFrame)).concat(directions.map(borderColorPropFrame)).concat(directions.map(borderOnly))
